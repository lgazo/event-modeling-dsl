...
import type { EventModelingAstType, Frame } from './generated/ast.js';
...
export function registerValidationChecks(services: EventModelingServices) {
    ...
    const checks: ValidationChecks<EventModelingAstType> = {
        ...
        Frame: validator.checkFrameEntityExists
    };
...
export class EventModelingValidator {
    ...
    checkFrameEntityExists(frame: Frame, accept: ValidationAcceptor): void {
        /**
